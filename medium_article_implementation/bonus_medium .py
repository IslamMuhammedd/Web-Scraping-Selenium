'''
Here's Some edit happended to The code by Islam Mohamed
After Reading The Article on medium to scrape books details Through different pages

'''
#----------------------------------
# Name : Islam Mohamed Mohamed 
# SW   : Web Scraping Using Selenium
# Date : 3/01/2022
# Course: Data Preparation and Exploration
#---------------------------------
